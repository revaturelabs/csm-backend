...
class CaliberProcessingTest(unittest.TestCase):
    ...
    def test_get_qc_data(self, mock_a, mock_b):
        ...
        self.assertEqual(result[0], {'skill': 'Java',
                                     'score': 'Average',
    ...
    def test_get_batch_and_associate_spider_data(self, mock_assoc_spider, mock_batch_spider):
        '''this method is to test the batch_and_associate_spider_data
        function in caliber_processing'''
    ...
    def test_get_batch_info(self, mock_a):
        ...
        mock_a.return_value = {'id': 223, 'batchId': 'TR-1345', 'name': 'Mock Batch 223',
                               ...
                               'location': 'New York', 'type': 'Revature', 'goodGrade': 70,
                               'passingGrade': 80,
                               'employeeAssignments': [{'role': 'ROLE_LEAD_TRAINER',
                                                        'employee': {'email':
                                                                     'mock1223.employee906bb611-' +
                                                                     'b2a8-4dce-b70f-94f5fd97da44' +
                                                                     '@mock.com',
                                                                     'firstName': 'Mock 1223',
                               ...
                               'associateAssignments':[
                                   {'trainingStatus': 'Training', 'associate':
                                        {'email':
                                         'mock5.associateaea29a7d-5e25-4efc-' +
                                         'a773-9d45a9bac92a@mock.com',
                                         'salesforceId': 'SF-4934', 'firstName': 'Mock 5',
                                         'lastName': 'Associate 5', 'flag': None},
                                    'startDate': '2018-07-16', 'endDate': '2018-05-07',
                                    'active': True},
                                   {'trainingStatus': 'Training', 'associate':
                                        {'email':
                                         'mock12.associate709b5c28-660b-' +
                                         '4bd3-be46-7fe1856269a9@mock.com',
                                         'salesforceId': 'SF-4941', 'firstName': 'Mock 12',
                                         'lastName': 'Associate 12', 'flag': None},
                                    'startDate': '2018-07-16', 'endDate': '2018-05-07',
                                    'active': True},
                                   {'trainingStatus': 'Training', 'associate':
                                        {'email':
                                         'mock7.associatebf0ac099-ae25-' +
                                         '4330-83cc-bd3968528471@mock.com',
                                         'salesforceId': 'SF-4936', 'firstName': 'Mock 7',
                                         'lastName': 'Associate 7', 'flag': None},
                                    'startDate': '2018-07-16', 'endDate': '2018-05-07',
                                    'active': True},
                                   {'trainingStatus': 'Training', 'associate':
                                        {'email':
                                         'mock3.associate80b10a09-f2eb-' +
                                         '499b-a29b-86b2b7abe9e3@mock.com',
                                         'salesforceId': 'SF-4932', 'firstName': 'Mock 3',
                                         'lastName': 'Associate 3', 'flag': None},
                                    'startDate': '2018-07-16', 'endDate': '2018-05-07',
                                    'active': True},
                                   {'trainingStatus': 'Training', 'associate':
                                        {'email':
                                         'mock4.associate2c462444-afd6-' +
                                         '416a-b81e-9211ba20451d@mock.com',
                                         'salesforceId': 'SF-4933', 'firstName': 'Mock 4',
                                         'lastName': 'Associate 4', 'flag': None},
                                    'startDate': '2018-07-16', 'endDate': '2018-05-07',
                                    'active': True},
                                   {'trainingStatus': 'Training', 'associate':
                                        {'email':
                                         'mock11.associate4ce6aa14-91e0-' +
                                         '42fa-bf05-19cd3b8d3f8c@mock.com',
                                         'salesforceId': 'SF-4940', 'firstName': 'Mock 11',
                                         'lastName': 'Associate 11', 'flag': None},
                                    'startDate': '2018-07-16', 'endDate': '2018-05-07',
                                    'active': True},
                                   {'trainingStatus': 'Training', 'associate':
                                        {'email':
                                         'mock0.associateb8d5b410-852e-' +
                                         '4226-b6c1-8902c51f7b11@mock.com',
                                         'salesforceId': 'SF-4929', 'firstName': 'Mock 0',
                                         'lastName': 'Associate 0', 'flag': None},
                                    'startDate': '2018-07-16', 'endDate': '2018-05-07',
                                    'active': True}]}
        result = get_batch_info('TR-1345')
        self.assertEqual(result['trainer'][0]['employee']['firstName'], 'Mock 1223')
        self.assertEqual(result['associates'][1]['userID'],
                         'mock12.associate709b5c28-660b-4bd3-be46-7fe1856269a9@mock.com')
